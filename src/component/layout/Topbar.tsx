...
const TopBar: React.FC = () => {
  ...
  return (
    <div className="container-fluid bg-primary px-3 px-lg-5 py-2">
      <div className="row gx-0 align-items-center">
        <div className="col-8 col-lg-8 text-start mb-2 mb-lg-0">
          <div className="d-inline-flex align-items-center justify-content-center justify-content-lg-start" style={{ height: '45px' }}>
        ...
        <div className="col-4 col-lg-4 text-end">
          <div className="d-inline-flex align-items-center justify-content-center justify-content-lg-end" style={{ height: '45px' }}>
            {!accessToken && (
              <>
                <a href="/signup">
